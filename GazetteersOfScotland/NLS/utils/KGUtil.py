...
if __name__ == '__main__':
    ...
    gazetteers_data_mapping_file_path = str(parent_path) + '/gazetteers.txt'
    gazetteers_data_file_path = '/Users/ly40/Downloads/nls-data-gazetteersOfScotland'
    create_nls_folder_path_mapping_file(gazetteers_data_mapping_file_path, gazetteers_data_file_path)
